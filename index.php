...
footer{
	...
	<body style="background: yellow;">
		<nav class="navbar navbar-default navbar-fixed-top" style="background:">
			<div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand"><strong><i class="glyphicon glyphicon-list-alt "></i> Welcome - Please Login</strong></a>
                </div>
			</div>
		</nav>	
		<!-- navbar ends-->
		<div class="container-fluid" style="background-image: linear-gradient(lightgreen, yellow); margin-top:50px;">
			<br/><div class="row">
				<!-- Main Menu -->
            <div class="col-sm-3"></div>
				<div class="col-sm-3">
                    <div class="panel" style="border-radius:0px; box-shadow:2px 2px 4px 0px">
                        ...
                        <div class="panel-body" style="margin-top:-30px;">
                           <center>
                                  <a class="btn btn-success" style="padding:15px 20px;" href="chatbox/"><i class="glyphicon glyphicon-log-in"></i>  Login/Sign Up</a>
                         </center>
                        </div>
                    </div>
                </div>
				...
				<div class="col-sm-3">
                    <div class="panel" style="border-radius:0px; box-shadow:2px 2px 4px 0px">
                        ...
                        <div class="panel-body" style="margin-top:-30px;">
                           <center>
                               <a class="btn btn-success" style="padding:15px 20px;" href="chatbox/admin/"><i class="glyphicon glyphicon-log-in"></i>  Login</a>
                            </center>
                        </div>
                    </div>
                </div>
		...
		<footer class="container-fluid" style="background:#444; color:#fff;">
            <p align="center">Copyright @ &copy; 2022 develop by jenil amipara & maulik thummar</p>
            <p align="center">weText</p>
        </footer>
		<!-- footer end-->
	</body>
</html>