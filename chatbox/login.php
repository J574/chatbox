...
?><html>
		...
		<nav class="navbar navbar-default navbar-fixed-top" style="background: pink;">
  			<div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand"><b><i class="glyphicon glyphicon-lock"></i> User Login/Sign Up</b></a></li>
                </div>
            </div>
	  	</nav>	
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading" style="background:red; color:white; font-size:16px;">
    ...
    <footer class="container-fluid" style="background:#444; font-size:19px; color:#fff;">
            <p align="center" style="padding-top:5px;">Copyright @ &copy; 2022 develop by jenil amipara & maulik thummar</p>
